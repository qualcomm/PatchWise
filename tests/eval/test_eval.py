...
"""pytest entry point for the bug-recall evaluation harness.
...
Can also be run directly:
    python3 tests/eval/test_eval.py --reviews-dir ../pw-tests/ai_reviews ...
"""
...
# Allow both `pytest` (package import) and `python3 tests/eval/test_eval.py` (script).
if __package__:
    from .run import (
...
def test_eval_pipeline(request: pytest.FixtureRequest) -> None:
